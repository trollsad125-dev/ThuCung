        ...
        <div class="row">
            <div class="col-md-12">
                                ...
                                <div class="product-item"><img src="/static/images/tour/${prod.tour.hinh}" alt="chưa có hình">
                                    <div class="product-info"><a class="product-name" href="/tour/detail/${prod.tour.maTour}">${prod.tour.tenTour}</a>
                                        ...
                                        <div class="product-review">
                                            <a class="back" href="/admin/qldontour/back">Quay lại</a>
                                        </div>
                                    </div>
                                </div>
                            </td>
              ...
              <c:if test="${not empty hidden }">
               ...
               <form:form action="/admin/qldontour/seeDetail" modelAttribute="form"
				...
				<form:hidden path="maThongTin" />
                    <div class="form_info_update">
                        ...
                        <div class="form-group row">
                            <form:button formaction="/admin/qldontour/seeDetail/${maDonTour}/create" class="btn save4 text-uppercase" disabled="${!empty form.maThongTin}"><i class="fa fa-save"></i> Save</form:button>
                            <form:button formaction="/admin/qldontour/seeDetail/${maDonTour}/update" class="btn update4 text-uppercase" disabled="${empty form.maThongTin}"><i class="fa fa-edit"></i> Update</form:button>
                            <a href="/admin/qldontour/seeDetail/${maDonTour}" class="btn refresh4 text-uppercase"><i class="fa fa-refresh fa-spin"></i>
                                refresh</a>
                        </div>
                    </div>
				</form:form>                    
							...
							<td class="row">
								<div class="button_admin">
									<a data-toggle="tooltip" data-placement="top"
										title="See Detail"
										href="/admin/qldontour/seeDetail/${item.donTour.maDonTour}/seeDetail/${item.maThongTin}"
										type="button" class="button_see" class="btn"><i
										class='fas fa-eye'></i> </a>
									<c:if test="${prod.trangThaiDuyetDon eq '0'}">
										<a
											href="/admin/qldontour/seeDetail/${item.donTour.maDonTour}/edit/${item.maThongTin}"
						...
						<div class="modal fade" id="${st.count}"  tabindex="-1"
							...
							<div class="modal-dialog">
									...
									<div class="modal-content">
										...
										<a href="/admin/qldontour/seeDetail/${item.donTour.maDonTour}/delete/${item.maThongTin}"
