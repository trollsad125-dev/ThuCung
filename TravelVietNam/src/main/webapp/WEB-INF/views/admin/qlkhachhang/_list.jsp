			...
			<tr class="contentPage" >
				...
				<td class="row">
					<div class="button_admin">
						<a  data-toggle="tooltip" data-placement="top" title="See Detail" href="/admin/qlkhachhang/seeDetail/${item.maKhachHang}"
							type="button" class="button_see" class="btn"> <i
							class='fas fa-eye'></i></a> 
							<a  data-toggle="tooltip" data-placement="top" title="Edit"
							href="/admin/qlkhachhang/edit/${item.maKhachHang}"
						...
						<div class="modal fade" id="${st.count}1"  tabindex="-1"
							...
							<div class="modal-dialog">
									...
									<div class="modal-content">
										...
										<a href="/admin/qlkhachhang/delete/${item.maKhachHang}"
