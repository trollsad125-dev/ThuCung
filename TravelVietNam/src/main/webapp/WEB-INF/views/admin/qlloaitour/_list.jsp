...
<%@ taglib uri="http://java.sun.com/jstl/core_rt" prefix="c"%>
		...
		<c:set var="slCTT" value="${slCTT + 1}" />
							<tr class="contentPage">
								<td>${item.idLoaiTour}</td>
								<td>${item.tenLoaiTour}</td>
								<td class="row">
									<div class="button_admin">
											<a data-toggle="tooltip" data-placement="top" title="Edit" href="${ctrl}/edit/${item.idLoaiTour}" 
											type="button" class="button_edit" class="btn"> <i class='fas fa-edit'></i></a>
										
											<a type="button" data-toggle="modal" data-target="#${st.count}" type="button" class="button_delete" class="btn"><i
						...
						<div class="modal fade" id="${st.count}"  tabindex="-1"
							...
							<div class="modal-dialog">
									...
									<div class="modal-content">
										...
										<a href="${ctrl}/delete/${item.idLoaiTour}"
