    ...
    <section class="bread-crumb margin-bottom-10">
            <div class="container">
                <ul class="breadcrumb" itemscope="" itemtype="https://schema.org/BreadcrumbList">
                    ...
                    <li itemprop="itemListElement" itemscope="" itemtype="https://schema.org/ListItem"> <strong itemprop="name">Nhân viên chi tiết</strong>
                        <meta itemprop="position" content="2"> </li>
                </ul>
            </div>
        </section>
        <form action="/admin/qlnhanvien/back" method="post">
        <!--FORM_NV_CT-->
        <div class="container">
            <div class="wrapper">
                <div class="left">
                    ...
                    alt="user" width="100">
                    <h4>${prod.tenNhanVien}</h4>
                
                        <i class='fas fa-user-tie' style="font-size: 30px;"></i>
                     <p>INFO - <c:if test="${prod.vaiTro eq 'true'}">Admin</c:if>
                     <c:if test="${prod.vaiTro eq 'false' }">Person</c:if></p>
                ...
                <div class="right">
                    <div class="info">
                       ...
                       <div class="info_data row">
                        ...
                        <div class="data">
                          <h4>Vai trò</h4>
                           <p><c:if test="${prod.vaiTro eq 'true'}">Admin</c:if> 
				<c:if test="${prod.vaiTro eq 'false' }">Person</c:if></p>
                     </div>
                     <div class="data">
                       <h4>Password</h4>
