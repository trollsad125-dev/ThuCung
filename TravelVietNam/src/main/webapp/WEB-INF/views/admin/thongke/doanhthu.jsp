...
<div class="container">
	<div class="row">
		...
		<div class="panel-heading">
			<strong class="panel-title">BÁO CÁO DOANH THU THEO LOẠI TOUR</strong>
		</div>
		<div class="col-md-12">
			...
			<div class="tab_QL">
				<ul class="nav nav-tabs myTab">
					<li class="active chart"><a href="#customer" data-toggle="tab"
						aria-expanded="true"><i class='fa fa-pie-chart'></i> BIỂU ĐỒ</a></li>
					<li class="chart"><a href="#BD" data-toggle="tab"
						aria-expanded="true"><i class='fa fa-table'></i> BẢNG SỐ LIỆU</a></li>
				</ul>
			</div>
		</div>
	</div>
...
<input class="form-control" type="text" id="myInput" onkeyup="myFunction()" placeholder="Tìm Kiếm Theo Từ Khóa..">
	<div class="tab-content">
		<div class="tab-pane active" id="customer">
			<%@include file="doanhthu_chart.jsp"%>
		</div>
