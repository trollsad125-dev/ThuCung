...
<div class="container">
	<div class="row">
        ...
        <strong class="panel-title">BÁO CÁO DOANH THU THEO NĂM</strong>
    </div>
		<div class="col-md-12">
			...
			<div class="tab_QL">
				<ul class="nav nav-tabs myTab">
					<li class="active chart"><a href="#customer" data-toggle="tab"
						aria-expanded="true"><i class='fa fa-calendar-alt'></i> BIỂU ĐỒ</a></li>
...
<input class="form-control" type="text" id="myInput" onkeyup="myFunction()" placeholder="Tìm Kiếm Theo Từ Khóa..">
	<div class="tab-content">
		<div class="tab-pane active" id="customer">
			<%@include file="doanhthu_nam_chart.jsp"%>
		</div>
