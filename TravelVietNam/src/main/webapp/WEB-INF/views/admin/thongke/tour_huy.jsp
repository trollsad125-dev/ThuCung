...
<div class="container">
	<div class="row">
		...
		<div class="panel-heading">
			<strong class="panel-title">CÁC TOUR ĐÃ HỦY TRONG THÁNG</strong>
		</div>
		<div class="col-md-12">
			...
			<div class="tab_QL">
				<ul class="nav nav-tabs myTab">
					<li class="active chart"><a href="#customer" data-toggle="tab"
						aria-expanded="true"><i class='fa fa-window-close'></i> BIỂU ĐỒ</a></li>
...
<input class="form-control" type="text" id="myInput" onkeyup="myFunction()" placeholder="Tìm Kiếm Theo Từ Khóa..">
	<div class="tab-content">
		...
		<%@include file="thongketourhuy_chart.jsp"%>
		</div>
