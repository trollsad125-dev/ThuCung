...
<a href="/trangthaitour/index" style="text-decoration: none;"><button class="btn btn-block"><i class="fa fa-suitcase"></i> Đơn Tour</button></a>
</div>
...
<div class="form_info_update">
    <div class="form-group row">
        ...
        <div class="col-md-8">
            <form:input path="tenKhachHang" class="form-control" required="f" placeholder="Họ Và Tên" name="lh_name" type="text" />
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-8">
            <form:input path="cmnd" class="form-control numeric" maxlength="11" required="f" placeholder="Chứng Minh Nhân Dân" name="lh_name" type="text"/>
        </div>
    </div>
	<div class="form-group row">
   ...
   <a href="/account/change" class="btn booking1 text-uppercase">CHANGE PASSWORD</a>
